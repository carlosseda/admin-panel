<div class="messages-container" id="messages-container">
    ...
    <div class="message validation">
        ...
        <div class="message-content">
            <p class="message-type">@lang('admin/messages.message-type-validation')</p>
            <p class="message-description" id="message-description-validation"></p>
        </div>
